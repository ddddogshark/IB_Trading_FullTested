...
if __name__ == "__main__":
    ...
    ib = IB()
    print("🚀 启动ib_async项目主函数...")
    print("=" * 60)
    print("连接配置:")
    print("- 主机: 127.0.0.1")
    print("- 端口: 4001 (Gateway)")
    print("- 客户端ID: 1")
    print("=" * 60)
    
    try:
        # 连接到Gateway
        print("正在连接到IB Gateway...")
        ...
        print(f"✅ 账户摘要: {len(account_summary)} 项")
        
        # 获取持仓信息
        positions = ib.positions()
        print(f"✅ 持仓信息: {len(positions)} 项")
